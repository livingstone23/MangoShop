...
public abstract class Repository<TEntity> : IRepository<TEntity> where TEntity : Entity
{
    ...
    protected readonly MangoDbContext _db;

    protected readonly DbSet<TEntity> _dbSet;

    protected readonly ILogger<Repository<TEntity>> _logger;
    
    private MangoDbContext context;
    ...
    public Repository(MangoDbContext db, ILogger<Repository<TEntity>> logger)
    {
    ...
    protected Repository(MangoDbContext context)
    {
